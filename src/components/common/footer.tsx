      ...
      <div className="container-boreas py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link href="/salones" className="hover:text-white transition-colors">Salones de belleza</Link></li>
              <li><Link href="/restaurantes" className="hover:text-white transition-colors">Restaurantes</Link></li>
              <li><Link href="/clinicas" className="hover:text-white transition-colors">Clínicas médicas</Link></li>
              <li><Link href="/spas" className="hover:text-white transition-colors">Spas</Link></li>
              <li><Link href="/gimnasios" className="hover:text-white transition-colors">Gimnasios</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <a
                href="https://twitter.com/boreas_mx"
              ...
              <a
                href="https://facebook.com/boreas.mx"
                className="text-gray-400 hover:text-white transition-colors"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://linkedin.com/company/boreas-mx"
                className="text-gray-400 hover:text-white transition-colors"
                target="_blank"
                rel="noopener noreferrer"
              >
