...
## Criterio Done
- [ ] Migration SQL aplicada en Supabase (tabla existe, RLS configurado, trigger activo)
- [ ] Usuario admin existe en `auth.users` Y en `public.users` con `role='admin'`
- [ ] Query de verificación retorna el usuario admin correctamente
